...
.typeString('<span class="php-tag"> <h1> Julien PABLO</h1></span>')
    .typeString('<ol class="list-unstyled">\n' +
        ...
        '        <li style="overflow: hidden"><a href="mailto:julien.pablo.pro@gmail.com" target="_blank"><i class="fa-solid fa-envelope m-2 fa-xl" style="color: white;"></i>julien.pablo.pro@gmail.com</a></li>\n' +
        '      </ol>')
    .pauseFor(300)
    .typeString('<span class="php-text">echo</span>')
